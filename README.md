...
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=20&duration=3000&pause=1000&color=10B981&center=true&vCenter=true&width=750&lines=🌿+Detect+Crop+Diseases+with+Gemini+Vision;🤖+24%2F7+Conversational+Farming+Advisor;📈+Predictive+Weather+%26+Yield+Analysis;🏛+Smart+Government+Scheme+Matching" alt="Typing SVG" />
...
<p>
  ...
  <img src="https://img.shields.io/badge/Stack-React_%7C_Node-00684A?style=for-the-badge&logo=react&logoColor=white" />
...
flowchart TD
    ...
    G --> H[(💾 Saved to MongoDB\nUser Scan History)]
    G --> I[🖥️ React UI Display]
    ...
    style I fill:#14532d,color:#fff,stroke:#16a34a
```
...
graph TB
    ...
    style DB fill:#0f2027,color:#fff,stroke:#10B981
```
...
![Visitor Count](https://visitor-badge.laobi.icu/badge?page_id=abhishek-ms-01.agri-intelligence-platform&style=for-the-badge&color=10B981)
